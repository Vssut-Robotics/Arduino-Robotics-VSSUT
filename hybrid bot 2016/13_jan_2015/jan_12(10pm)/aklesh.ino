...
void setup(){
 ...
 error = ps2x.config_gamepad(A0,47,45,49, true, true);   //setup pins and settings:  GamePad(clock, command, attention, data, Pressures?, Rumble?) check for error
 ...
 if(ps2x.ButtonPressed(GREEN_FRET))
  ...
  {Serial.println("circle");}
   ...
   {Serial.println("cross");}
      //Analog stick values
  else if(ps2x.Button(PSB_PAD_UP)) {Serial.println("uuuuuuup");}
...
Serial.println("left");
  ...
  else if(ps2x.Button(PSB_PAD_DOWN)) {Serial.println("back");}
  else       
    {
